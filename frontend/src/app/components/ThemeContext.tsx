...
// Theme definitions
export type ThemeName = 'default' | 'bw' | 'midnight' | 'cosmic' | 'skies' | 'sakura' | 'nature' | 'noob' | 'clean' | 'ultradark' | 'banana' | 'steamhappy' | 'space' | 'tech' | 'ocean' | 'sunset' | 'candy' | 'inferno' | 'winter';
export type EffectType = 'blocks' | 'stars' | 'orbs' | 'clouds' | 'petals' | 'leaves' | 'none' | 'bananas' | 'steam' | 'planets' | 'matrix' | 'bubbles' | 'vaporwave' | 'sweets' | 'embers' | 'snow';
...
export const THEMES: Theme[] = [
  ...
  },
  {
    ...
    colors: {
      ...
      accent: '#ff007f',
      success: '#7b2cbf',
      background: 'linear-gradient(135deg, #0b0c10 0%, #1f2833 50%, #120136 100%)',
      cardBg: '#1a1d24',
      textPrimary: '#ffffff',
      textSecondary: '#c5c6c7',
      onBgText: '#ffffff',
      onBgTextSecondary: '#66fcf1',
      gradient1: '#66fcf1',
      gradient2: '#ff007f',
      gradient3: '#45a29e',
      gradient4: '#7b2cbf',
  ...
  },
  {
    ...
    colors: {
      ...
      accent: '#39d353',
      success: '#26a641',
      background: 'linear-gradient(135deg, #0d1117 0%, #161b22 50%, #031308 100%)',
      cardBg: '#161b22',
      textPrimary: '#00ff66',
      textSecondary: '#8b949e',
      onBgText: '#00ff66',
      onBgTextSecondary: '#58a6ff',
      gradient1: '#00ff66',
      gradient2: '#00e5ff',
      gradient3: '#39d353',
      gradient4: '#1f6f32',
  ...
  },
  {
    ...
    colors: {
      ...
      accent: '#9d4edd',
      success: '#ffbe0b',
      background: 'linear-gradient(135deg, #240046 0%, #5a189a 50%, #7b2cbf 100%)',
      cardBg: '#3c096c',
      textPrimary: '#ffffff',
      textSecondary: '#e0aaff',
      onBgText: '#ffffff',
      onBgTextSecondary: '#ff9e00',
      gradient1: '#ff6d00',
      gradient2: '#ff006e',
      gradient3: '#9d4edd',
      gradient4: '#ffbe0b',
  ...
  },
  {
    ...
    colors: {
      ...
      accent: '#caffbf',
      success: '#bdb2ff',
      background: 'linear-gradient(135deg, #fec8d8 0%, #ffdfd3 50%, #d291bc 100%)',
      cardBg: '#fff0f5',
      textPrimary: '#6d6875',
      textSecondary: '#b5838d',
      onBgText: '#4a3f35',
      onBgTextSecondary: '#6d6875',
      gradient1: '#ff85a1',
      gradient2: '#a0c4ff',
      gradient3: '#caffbf',
      gradient4: '#bdb2ff',
  ...
  },
  {
    ...
    colors: {
      ...
      accent: '#ffbe0b',
      success: '#fb5607',
      background: 'linear-gradient(135deg, #1a0505 0%, #370617 50%, #6a040f 100%)',
      cardBg: '#2b0909',
      textPrimary: '#ffedd8',
      textSecondary: '#f48c06',
      onBgText: '#ffffff',
      onBgTextSecondary: '#ffba08',
      gradient1: '#ff2a00',
      gradient2: '#ff7a00',
      gradient3: '#ffbe0b',
      gradient4: '#dc2f02',
